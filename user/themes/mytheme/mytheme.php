...
class MyTheme extends Theme
{
    ...
    public function onThemeInitialized()
    {
        ...
        if ($this->config->get('themes.mytheme.enabled')) {
            $this->enable([
    ...
    {
        $config = $this->config->get('themes.mytheme');
        ...
        $collection[] = 'theme://assets/css-compiled/mytheme.css';
        $collection[] = 'theme://assets/js/mytheme.js';
        
        $assets = $this->grav['assets'];
        $assets->registerCollection('mytheme', $collection);
        $assets->add('mytheme', 100);
    }
}
